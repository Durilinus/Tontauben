...
public class TaubeFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        oberflaeche2 = new mendykjanniktontauben.Oberflaeche();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TaubeFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TaubeFrame().setVisible(true);
            }
        });
    }
    ...
    private mendykjanniktontauben.Oberflaeche oberflaeche2;
